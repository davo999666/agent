...
@tool
def take_screenshot(dummy: str = ""):
    """Return screenshot as base64 image for vision LLM and save locally."""
    ...
    try:
        ...
        # Save locally (for YOU only, not LLM)
        ...
        # IMPORTANT: do NOT return file path to LLM
        return {
            "type": "image",
            "image": encoded,
        }
